...
export function rollGame(
  ...
  return performAction('roll', accessToken, gameId, signal)
}
...
export function holdGame(
  ...
  return performAction('hold', accessToken, gameId, signal)
}
...
export function restartGame(
  ...
  return performAction('restart', accessToken, gameId, signal)
}
